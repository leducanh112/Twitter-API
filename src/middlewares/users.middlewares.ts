...
const confirmPasswordSchema: ParamSchema = {
  ...
  isString: {
    errorMessage: USERS_MESSAGES.CONFIRMPASSWORD_MUST_BE_STRING
  },
  isLength: {
  ...
  checkSchema(
    {
      ...
      email: {
        ...
        custom: {
          options: async (value) => {
            const exists = await usersService.checkEmailExist(value)
            if (exists) {
  ...
  checkSchema(
    {
      ...
      location: {
        ...
        isLength: {
          options: { min: 0, max: 200 },
          errorMessage: USERS_MESSAGES.LOCATION_LENGTH_MUST_BE_BETWEEN_0_AND_200
        },
        optional: true
      },
      website: {
        ...
        isLength: {
          options: { min: 0, max: 200 },
          errorMessage: USERS_MESSAGES.WEBSITE_LENGTH_MUST_BE_BETWEEN_0_AND_200
        },
        optional: true
      },
      username: {
